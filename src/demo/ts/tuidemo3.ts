...
const toBeLined = makeChildBorderGenerator(maskRast => {
	const lineStyle = BDC_PROP_VALUES.LIGHT;
	const lineColor = ansi.WHITE_TEXT;
	...
	return boxDrawr.contentToRaster(lineColor);
});
